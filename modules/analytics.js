...
////////////////////////通用
	...
	else if (trigger.match(/^coc建立帳號$/) != null) return exports.cocCha.CreateAccount(UserID) ;//CoC選單
...
////////////////////////CoC選單
	...
	else if (trigger.match(/^角色登記$/) != null) return exports.cocCha.createCha(UserID,mainMsg[1]) ;//角色登記
