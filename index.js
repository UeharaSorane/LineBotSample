	...
	function GameInformation(InformationN) {
		...
		if(InformationN == 0){
			...
			return '\【補償】 眾多補償 \
				\n\
				\n1.技能更動補償:\
				\n  持有技能「斬擊」,「火球」的全體玩家，將分別贈予「奇蹟石x1」作為補償\
				\n\
				\n2.更新延遲補償:\
				\n  因個人因素導致預期更新時間延誤，將贈與全體玩家「奇蹟石x10」作為補償\
				\n\
				\n\
			...
			return '\【公告目錄】目前遊戲中的公告一覽表 \
				\n\
				\n  0 【新系統】武器適性 追加!!!(NEW)\
				\n  1 【重要】 先行測試2(公開測試) 正式開始!\
				\n  2 【更新】 本次更新介紹(NEW)\
				\n  3 【補償】 眾多補償(NEW)\
				\n  4 【重要】 請加空音好友以取得最新消息 \
				\n  5 【補償】 治癒技能更動補償(NEW) \
				\n  6 【補償】 冰獄彈技能描述錯誤補償(NEW) \
				\n  7 【補償】 毒、猛毒說明缺失及轟炎彈技能描述錯誤補償(NEW) \
				\n  8 【活動預告】恭喜發財紅包拿來!壓歲錢狩獵!?(NEW) \
				\n\
