	...
	function MainStory(StoryPart,StoryN) {
		...
		if(StoryPart == '第四部'||StoryPart == 'Part4'||StoryPart == '4'){
			...
			if(StoryN == '1-1'){
				...
				\n 對手:幸\
				\n 通關獎勵:(10d2)G金幣\
				\n 故事:在歷經一番波折後，露終於如願以償的回到了她的故鄉-「湖之村」。\
				...
				\n 對手:塞恩\
				\n 通關獎勵:(10d2)G金幣\
				\n 故事:儘管露再怎麼解釋，他們仍舊不相信她就是千年前戰死的英雄，究竟，該怎麼證明自己呢？ \
				';
				...
				\n 對手:盜賊\
				\n 通關獎勵:(10d3)G金幣\
				\n 故事:當他們爭執不下時，突然出現一班盜賊要洗劫湖之村！面對來勢兇猛的盜賊，露認為這是證明自己的大好機會。 \
				';
				...
				\n 對手:莎拉\
				\n 通關獎勵:(10d3)G金幣\
				\n 故事:在親妹妹「聖風的祈願者」莎拉的確認下，露終於被村人認同，面對千年來的姊妹重逢，沙拉在高興之餘也希望能從姊姊\
				\那邊學習一點劍術，所以決定向露發起挑戰\
				';
				...
				\n 通關獎勵:100G金幣\
                  		\n 5%機率獲得技能書「風刃」\
				\n\
				\n 故事:露想起三年前被下的詛咒，如果她不及早破除詛咒，莎拉就會死亡！為了避免悲劇發生，露決定再度離開湖之村，可是\
				\湖之村的入口卻被莎拉擋住了!?\
				';
				...
				return '\第四部 第一章-劍聖再臨\
				\n\
				\n 故事:在路卡解決奧賽羅爾事件的三年後，復活的風之劍聖-露在歷經許多事件後，終於回到了湖之村，可是她得到的竟只有無情的對待...\
				\n 第一章突破獎勵: 技能書「祈願」\
				\n\
				\n 關卡情報:\
				\n 1-1 不安的氣氛\
